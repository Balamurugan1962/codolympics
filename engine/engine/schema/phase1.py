...
Section A is the puzzles, Section B the hacking questions; `p1_advancement`
...
p1_hack_question = Table(
    ...
    Column("given_source", Text, nullable=False),
    Column("given_language", Text, nullable=False),
