...
/** Phase 1 standings: points from the puzzles and the hacks, and who went through. */
export function Phase1Board() {
  ...
  return (
    <PageBody className="animate-fade-in">
      ...
      {!board ? <BoardSkeleton rows={8} cols={5} /> : board.mode === "hidden" && state?.viewer.role === "participant" ? (
