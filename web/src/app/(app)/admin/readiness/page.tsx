          ...
          {groups.map((g) => {
            ...
            return (
              <Section
                ...
                actions={
                  <span className={cn("text-[12px] font-semibold tabular-nums", left ? "text-amber" : "text-green-dark")}>
                  ...
                  {g.items.map((it) => (
                    <li key={it.key}>
                      <Link href={it.href} className="flex items-center gap-3.5 px-5 py-3 transition-colors hover:bg-muted/50">
                        ...
                        <span className="hidden shrink-0 items-center gap-1 text-[12px] font-semibold text-green-dark sm:flex">
