...
/**
 * The order participants meet Phase 1 questions in.
 *
 * Ordering is its own page rather than a column you edit in the list, because
 * it is a decision about the shape of the round — easy first, or a hard one
 * early to spread the field — and you make it by looking at the whole set at
 * once. Nothing saves until you say so, so you can try an order and abandon it.
 */
  ...
  return (
    <PageBody>
      <PageHeader
        ...
        description="Drag to reorder, or focus a row and use the arrow keys. Participants may answer in any order — this is the order they are shown in."
      />
...
function OrderPanel({ section }: { section: "puzzles" | "hacking" }) {
