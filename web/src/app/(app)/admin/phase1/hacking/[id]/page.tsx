...
export default function EditHackPage() {
  ...
  const crumb = <Link href="/admin/phase1/hacking" className="inline-flex items-center gap-1 hover:text-ink"><Icon.ChevronLeft size={14} /> Hacking questions</Link>;
  ...
  return (
    <PageBody width="wide">
      <PageHeader
        breadcrumb={crumb}
        title={hack.title}
        description={<span>Worth {hack.hackPoints} points, judged with <span className="font-mono">{hack.problemId}</span>.</span>}
